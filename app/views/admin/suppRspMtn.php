...
<body>
  ...
  <div class="container ">
    ...
    <h2 class="text-center">Liste des responsables de maintenance</h2>
    <div class="text-center">
      <span class="" style="color: red; font-size: 1.2em">
      <?php if(!empty($msgErr)) echo $msgErr; ?></span>
    </div>
    <table id="table_users" class=" text-center table  table-hover">
      ...
      <tbody> 
        ...
        <tr > 
          ...
          <td>
            <form action="<?php echo Router::url('admin/suppRspMtn');?>" method="post">
              <input  name="id" type="hidden" value="<?php echo $value->id ?>"/>
              <button type="submit" onclick="return confirm('Confirmer la suppression de l\'utilisateur?');"><i class='fas fa-trash-alt' style='font-size:16px'></i></button>
            </form>
          </td>
        </tr>
        <?php }}else{ ?>
    ...
    <h6 class="text-center mb-10"> <?php echo "Aucun utilisateur ajouter."; }?></h6>
  </div>
</body>
<footer>
